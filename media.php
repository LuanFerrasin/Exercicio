        ...
        <div id="conteudo">
            ...
            <div id="form">
                <form name="frmMedia" method="post" action="">
                    <div>
                        <label>Nota 1:</label>
                        <input type="text" name="txtn1" value="<?=$nota1?>" placeholder="Insira sua Nota:"> 
                    </div>
                    
                    <div>
                        <label>Nota 2:</label>
                        <input type="text" name="txtn2" value="<?=$nota2?>" placeholder="Insira sua Nota:"> 
                    </div>
                    
                    <div>
                        <label>Nota 3:</label>
                        <input type="text" name="txtn3" value="<?=$nota3?>" placeholder="Insira sua Nota:"> 
                    </div>
                    
                    <div>
                        <label>Nota 4:</label>
                        <input type="text" name="txtn4" value="<?=$nota4?>" placeholder="Insira sua Nota:">
                    </div>
