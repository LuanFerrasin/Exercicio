                ...
                <form name="frmMedia" method="post" action="">
                    <div>
                     ...
                     <label>Valor 2:</label>
                       ...
                       <div>
                        <input type="radio" name="rdocalculo" value="Somar" <?php
                        if($operacao == 'SOMAR')
                         echo('checked');
                        ?>  >  Somar
                      </div>
                      <div>
                        <input type="radio" name="rdocalculo" value="Subtrair"<?php
                     ...
                     ?>   > Subtrair
                      ...
                      <div>
                        <input type="radio" name="rdocalculo" value="Dividir"<?php
                        if($operacao == 'SOMAR')
                         echo('checked');
                      ?>  >  Dividir
                        <input id="input" type="submit" name="btncalc" value ="Calcular" >
                      </div>
                         </form>
                </div>
              <footer id="resultado">
